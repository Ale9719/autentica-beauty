...
export default function ContactCTA({ titolo, testo }: ContactCTAProps) {
  return (
    <section className="relative w-full px-6 lg:px-24 py-32 bg-white flex flex-col items-center justify-center">
      ...
      >
        ...
        dangerouslySetInnerHTML={{ __html: titolo || 'Il primo passo verso il tuo equilibrio.'}}
        />

        <p className="text-ab-tortora-dark/70 font-sans font-light text-base lg:text-lg leading-relaxed mb-12 max-w-lg mx-auto">
          {testo || 'Ogni percorso nasce da un ascolto profondo. Prenota la tua prima consulenza e iniziamo a disegnare il tuo rituale su misura.'}
        </p>
